...
import { categoryData, categoryResonse } from 'src/app/_models/user';
import { Router } from '@angular/router';

@Component({
  selector: 'app-ce',
  templateUrl: './ce.component.html',
  styleUrls: ['./ce.component.css',  '../../../assets/icon/svg-animated/svg-weather.css'],
  animations: [
...
export class CEComponent implements OnInit {
  ...
  constructor(public menuItems: MenuItems, private generalService :GeneralService, private router : Router) {
    this.navType = 'st5';
  ...
  showData(event){
    ...
    if(event.target.innerHTML =='Manage Categories'){
      this.openCategory = 'showData';
    }
  ...
  showSubCat(event){
    ...
    this.subCatItem = event
    this.showSubCategories = true;
    this.router.navigateByUrl('CE/dashboard/manage-products')
  }
