...
@Component({
    ...
    templateUrl: './phone-otp-verification.component.html',
    styleUrls: ['./phone-otp-verification.component.css']
})

export class PhoneOtpVerificationComponent implements OnInit {
    finalOtp: any;
    phoneNo_fp: any;
    otp: string;
